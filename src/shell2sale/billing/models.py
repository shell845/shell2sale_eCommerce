...
class BillingProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True) # warning: using ForeignKeyField() here is not good due to unique=True
    ...
    @property
    def has_card(self): # call instance.has_card
    ...
    def set_cards_inactive(self):
        ...
        print("set_cards_inactive", cards_qs)
...
class ChargeManager(models.Manager):
    ...
    def do(self, billing_profile, order_obj, card=None): # Charge.objects.do()
        ...
        c = stripe.Charge.create(
                  ...
                  currency = "hkd",
                  customer = billing_profile.customer_id, # obtained with Stripe.js
